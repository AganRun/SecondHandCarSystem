...
<html>
	...
	<body>
		...
		<div style="min-height:800px;">
			...
			<label style="margin-left:80px"><font size="4px">未发货订单列表</font></label>
			...
			<form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/shopOrderManage/queryNotSendById">
			
				<div class="form-group">
					<label class="col-sm-3 control-label">未发货订单编号 或 车辆名称</label>
					<div class="col-sm-6">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							<a href="${pageContext.request.contextPath }/shopOrderManage/sendOrderById?order_id=${order.getOrder_id() }"><button class="btn btn-warning"> 发 货  </button></a>
						</td>
					</tr>
					</c:forEach>
				...
				<center>
					<c:if test="${requestScope.queryKind == 'all' }">
						<ul class="pagination pagination-lg">
							<li><a href="${pageContext.request.contextPath }/shopOrderManage/orderNotSendList?currentpage=1">首页</a></li>
							<li><a href="${pageContext.request.contextPath }/shopOrderManage/orderNotSendList?currentpage=${requestScope.page.getFront()}">&laquo;上一页</a></li>
						    <li><a>${requestScope.page.getCurrentpage() }</a></li>
						    <li><a href="${pageContext.request.contextPath }/shopOrderManage/orderNotSendList?currentpage=${requestScope.page.getNext()}">下一页 &raquo;</a></li>
						    <li><a href="${pageContext.request.contextPath }/shopOrderManage/orderNotSendList?currentpage=${requestScope.page.getLast()}">尾页</a></li>
						</ul><br>
					</c:if>
					
					<c:if test="${requestScope.queryKind == 'idOrName' }">
						<ul class="pagination pagination-lg">
							<li><a href="${pageContext.request.contextPath }/shopOrderManage/queryNotSendById?currentpage=1&order_id=${ requestScope.queryString }&order_shop_id=${sessionScope.shoploginSession.getLogin_id() }">首页</a></li>
							<li><a href="${pageContext.request.contextPath }/shopOrderManage/queryNotSendById?currentpage=${requestScope.page.getFront()}&order_id=${ requestScope.queryString }&order_shop_id=${sessionScope.shoploginSession.getLogin_id() }">&laquo;上一页</a></li>
						    <li><a>${requestScope.page.getCurrentpage() }</a></li>
						    <li><a href="${pageContext.request.contextPath }/shopOrderManage/queryNotSendById?currentpage=${requestScope.page.getNext() }&order_id=${ requestScope.queryString }&order_shop_id=${sessionScope.shoploginSession.getLogin_id() }">下一页 &raquo;</a></li>
						    <li><a href="${pageContext.request.contextPath }/shopOrderManage/queryNotSendById?currentpage=${requestScope.page.getLast() }&order_id=${ requestScope.queryString }&order_shop_id=${sessionScope.shoploginSession.getLogin_id() }">尾页</a></li>
						</ul><br>
					</c:if>
				</center>	
			<div style="height:50px"></div>
