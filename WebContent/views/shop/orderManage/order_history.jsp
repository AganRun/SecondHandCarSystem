...
<html>
	...
	<body>
		...
		<div style="min-height:800px;">
			...
			<form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/shopOrderManage/queryHistoryById">
							
				<div class="form-group">
					<label class="col-sm-3 control-label">历史订单编号 或 车辆名称</label>
					<div class="col-sm-6">
				...
				<center>
					<c:if test="${requestScope.queryKind == 'all' }">
						<ul class="pagination pagination-lg">
							<li><a href="${pageContext.request.contextPath }/shopOrderManage/orderHistoryList?currentpage=1&order_shop_id=${sessionScope.shoploginSession.getLogin_id() }">首页</a></li>
							<li><a href="${pageContext.request.contextPath }/shopOrderManage/orderHistoryList?currentpage=${requestScope.page.getFront()}&order_shop_id=${sessionScope.shoploginSession.getLogin_id() }">&laquo;上一页</a></li>
						    <li><a>${requestScope.page.getCurrentpage() }</a></li>
						    <li><a href="${pageContext.request.contextPath }/shopOrderManage/orderHistoryList?currentpage=${requestScope.page.getNext()}&order_shop_id=${sessionScope.shoploginSession.getLogin_id() }">下一页 &raquo;</a></li>
						    <li><a href="${pageContext.request.contextPath }/shopOrderManage/orderHistoryList?currentpage=${requestScope.page.getLast()}&order_shop_id=${sessionScope.shoploginSession.getLogin_id() }">尾页</a></li>
						</ul><br>
					</c:if>
					
					<c:if test="${requestScope.queryKind == 'idOrName' }">
						<ul class="pagination pagination-lg">
							<li><a href="${pageContext.request.contextPath }/shopOrderManage/queryHistoryById?currentpage=1&order_id=${ requestScope.queryString }&order_shop_id=${sessionScope.shoploginSession.getLogin_id() }">首页</a></li>
							<li><a href="${pageContext.request.contextPath }/shopOrderManage/queryHistoryById?currentpage=${requestScope.page.getFront()}&order_id=${ requestScope.queryString }&order_shop_id=${sessionScope.shoploginSession.getLogin_id() }">&laquo;上一页</a></li>
						    <li><a>${requestScope.page.getCurrentpage() }</a></li>
						    <li><a href="${pageContext.request.contextPath }/shopOrderManage/queryHistoryById?currentpage=${requestScope.page.getNext() }&order_id=${ requestScope.queryString }&order_shop_id=${sessionScope.shoploginSession.getLogin_id() }">下一页 &raquo;</a></li>
						    <li><a href="${pageContext.request.contextPath }/shopOrderManage/queryHistoryById?currentpage=${requestScope.page.getLast() }&order_id=${ requestScope.queryString }&order_shop_id=${sessionScope.shoploginSession.getLogin_id() }">尾页</a></li>
						</ul><br>
					</c:if>
				</center>	
			<div style="height:50px"></div>
