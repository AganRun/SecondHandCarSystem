...
<html>
	...
	<body>
		...
		<div style="min-height:800px;">
			...
			<label style="margin-left:80px"><font size="4px">未收货订单列表</font></label>
				
			<div class="container">
				<a href="${pageContext.request.contextPath}/shopOrderManage/orderDeleteList?order_shop_id=${sessionScope.shoploginSession.getLogin_id() }"><button type="button" style="float:right" class="btn btn-info">回收站</button></a>
			...
			<form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/shopOrderManage/queryNotReceiveById">
			
				<div class="form-group">
					<label class="col-sm-3 control-label">未收货订单编号 或 车辆名称</label>
					<div class="col-sm-6">
			...
			<table class="table table-condensed table-hover" style="width:90%;" align="center">
				...
				<tbody>
					<c:forEach items="${requestScope.notReceiveOrder }" var="order">
					<tr>
						...
						<td><c:out value="${order.getOrder_time_send() }"></c:out></td>
						<td>
				...
				<center>
					<c:if test="${requestScope.queryKind == 'all' }">
						<ul class="pagination pagination-lg">
							<li><a href="${pageContext.request.contextPath }/shopOrderManage/orderNotReceiveList?currentpage=1&order_shop_id=${sessionScope.shoploginSession.getLogin_id() }">首页</a></li>
							<li><a href="${pageContext.request.contextPath }/shopOrderManage/orderNotReceiveList?currentpage=${requestScope.page.getFront()}&order_shop_id=${sessionScope.shoploginSession.getLogin_id() }">&laquo;上一页</a></li>
						    <li><a>${requestScope.page.getCurrentpage() }</a></li>
						    <li><a href="${pageContext.request.contextPath }/shopOrderManage/orderNotReceiveList?currentpage=${requestScope.page.getNext()}&order_shop_id=${sessionScope.shoploginSession.getLogin_id() }">下一页 &raquo;</a></li>
						    <li><a href="${pageContext.request.contextPath }/shopOrderManage/orderNotReceiveList?currentpage=${requestScope.page.getLast()}&order_shop_id=${sessionScope.shoploginSession.getLogin_id() }">尾页</a></li>
						</ul><br>
					</c:if>
					
					<c:if test="${requestScope.queryKind == 'idOrName' }">
						<ul class="pagination pagination-lg">
							<li><a href="${pageContext.request.contextPath }/shopOrderManage/queryNotReceiveById?currentpage=1&order_id=${ requestScope.queryString }&order_shop_id=${sessionScope.shoploginSession.getLogin_id() }">首页</a></li>
							<li><a href="${pageContext.request.contextPath }/shopOrderManage/queryNotReceiveById?currentpage=${requestScope.page.getFront()}&order_id=${ requestScope.queryString }&order_shop_id=${sessionScope.shoploginSession.getLogin_id() }">&laquo;上一页</a></li>
						    <li><a>${requestScope.page.getCurrentpage() }</a></li>
						    <li><a href="${pageContext.request.contextPath }/shopOrderManage/queryNotReceiveById?currentpage=${requestScope.page.getNext() }&order_id=${ requestScope.queryString }&order_shop_id=${sessionScope.shoploginSession.getLogin_id() }">下一页 &raquo;</a></li>
						    <li><a href="${pageContext.request.contextPath }/shopOrderManage/queryNotReceiveById?currentpage=${requestScope.page.getLast() }&order_id=${ requestScope.queryString }&order_shop_id=${sessionScope.shoploginSession.getLogin_id() }">尾页</a></li>
						</ul><br>
					</c:if>
				</center>	
			<div style="height:50px"></div>
