			...
			$(function() {
				...
				$("#person_tel").change(function(){
					...
					if( $oldTel == $person_tel_value){
	       			...
	       			$.post("${pageContext.request.contextPath}/shop/ajaxTextTelExist", 
	...
	<body>
		...
		<div style="border:solid red 1px">
			...
			<div style="height:130px;width:90%">
				<br><br>
				<a href="${pageContext.request.contextPath }/views/shop/userInfo/changePassword.jsp"><button type="button" style="float:right" class="btn btn-info">修改个人密码</button></a>
			</div>
	 
			<form class="form-horizontal" role="form" id="updateInfoForm" action="${pageContext.request.contextPath }/shop/saveUpdatePersonInfo">
				<div class="form-group">
