	...
	<body onload="startTime()">
		...
		<div class="nav-down">
			...
			<div class="rightcon">
				...
				<label style="margin-left:80px"><font size="4px">品牌（${requestScope.brand_name }）订单列表</font></label>
				...
				<table class="table table-condensed table-hover" style="width:90%;" align="center">
					...
					<tbody>
						<c:forEach items="${requestScope.brandOrderList }" var="order">
						<tr>
				...
				<div style="margin-left:80px">
					<br>
					<font size="3px"> 共 <c:out value="${requestScope.brandOrderList.size() }"></c:out> 条数据</font>
				</div>
