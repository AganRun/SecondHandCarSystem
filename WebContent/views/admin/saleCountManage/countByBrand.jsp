	...
	<body onload="startTime()">
		...
		<div class="nav-down">
			...
			<div class="rightcon">
				...
				<label style="margin-left:80px"><font size="4px">品牌销售统计列表</font></label>
				...
				<table class="table table-condensed table-hover" style="width:70%;" align="center">
					...
					<tbody>
						<c:forEach items="${requestScope.brandSaleList }" var="brand">
						<tr>
							<th>${brand.getBrand_id() }</th>
							<th>${brand.getBrand_name() }</th>
							<th>${brand.saleSum() }</th>
							<th>${brand.salePriceSum() }</th>
							<th>
								<a href="${pageContext.request.contextPath }/saleCountManage/saleOrderByBrand?brand_id=${brand.getBrand_id()}"><butto class="btn btn-info"> 详  情 </butto></a>
							</th>
						</tr>
						</c:forEach>
				...
				<div style="margin-left:150px">
					<br>
					<font size="3px"> 共 <c:out value="${requestScope.brandSaleList.size() }"></c:out> 条数据</font>
				</div>
