	...
	<body onload="startTime()">
		...
		<div class="nav-down">
			...
			<div class="rightcon">
				...
				<br><br>
				<font size="5px" face="黑体" style="margin-left:100px">欢迎您登录后台管理系统</font>
				...
				<div id="myCarousel" style="width:70%;margin-left:150px;" class="carousel slide">
					...
					<div class="carousel-inner">
						<div class="item active">
							<img src="${pageContext.request.contextPath}/static/admin/images/index_1.jpg" alt="First slide">
						</div>
						<div class="item">
							<img src="${pageContext.request.contextPath}/static/admin/images/index_2.jpg" alt="Second slide">
						</div>
						<div class="item">
							<img src="${pageContext.request.contextPath}/static/admin/images/index_3.jpg" alt="Third slide">
						</div>
						<div class="item">
							<img src="${pageContext.request.contextPath}/static/admin/images/index_4.jpg" alt="Fourth slide">
						</div>
					</div>
					<!-- 轮播（Carousel）导航 -->
