	...
	<body onload="startTime()">
		...
		<div class="nav-down">
			...
			<div class="rightcon">
				...
				<form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/adminOrderManage/queryNotSendById">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								...
								<a href="${pageContext.request.contextPath }/adminOrderManage/sendOrderById?order_id=${order.getOrder_id() }"><button class="btn btn-warning"> 发 货  </button></a>
							</td>
						</tr>
						</c:forEach>
					...
					<center>
						<c:if test="${requestScope.queryKind == 'all' }">
							<ul class="pagination pagination-lg">
								<li><a href="${pageContext.request.contextPath }/adminOrderManage/orderNotSendList?currentpage=1">首页</a></li>
								<li><a href="${pageContext.request.contextPath }/adminOrderManage/orderNotSendList?currentpage=${requestScope.page.getFront()}">&laquo;上一页</a></li>
							    <li><a>${requestScope.page.getCurrentpage() }</a></li>
							    <li><a href="${pageContext.request.contextPath }/adminOrderManage/orderNotSendList?currentpage=${requestScope.page.getNext()}">下一页 &raquo;</a></li>
							    <li><a href="${pageContext.request.contextPath }/adminOrderManage/orderNotSendList?currentpage=${requestScope.page.getLast()}">尾页</a></li>
							</ul><br>
						</c:if>
						
						<c:if test="${requestScope.queryKind == 'idOrName' }">
							<ul class="pagination pagination-lg">
								<li><a href="${pageContext.request.contextPath }/adminOrderManage/queryNotSendById?currentpage=1&order_id=${ requestScope.queryString }">首页</a></li>
								<li><a href="${pageContext.request.contextPath }/adminOrderManage/queryNotSendById?currentpage=${requestScope.page.getFront()}&order_id=${ requestScope.queryString }">&laquo;上一页</a></li>
							    <li><a>${requestScope.page.getCurrentpage() }</a></li>
							    <li><a href="${pageContext.request.contextPath }/adminOrderManage/queryNotSendById?currentpage=${requestScope.page.getNext() }&order_id=${ requestScope.queryString }">下一页 &raquo;</a></li>
							    <li><a href="${pageContext.request.contextPath }/adminOrderManage/queryNotSendById?currentpage=${requestScope.page.getLast() }&order_id=${ requestScope.queryString }">尾页</a></li>
							</ul><br>
						</c:if>
					</center>	
				<div style="height:50px"></div>
