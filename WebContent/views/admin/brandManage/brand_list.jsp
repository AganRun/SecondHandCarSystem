	...
	<body onload="startTime()">
		...
		<div class="nav-down">
			...
			<div class="rightcon">
				...
				<label style="margin-left:150px"><font size="4px">品牌管理</font></label>
				...
				<table class="table table-condensed table-hover" style="width:80%;" align="center">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<a href="${pageContext.request.contextPath}/admin/brandDetails?brand_id=${brand.getBrand_id()   }"><button class="btn btn-default"> 详  情 </button></a>
								<a href="${pageContext.request.contextPath}/admin/brandUpdateInit?brand_id=${brand.getBrand_id()   }"><button class="btn btn-info"> 修  改 </button></a>
								<a href="${pageContext.request.contextPath}/admin/deleteBrand?brand_id=${brand.getBrand_id() }"><button class="btn btn-danger"> 删  除 </button></a>
							</td>
						</tr>
						</c:forEach>
