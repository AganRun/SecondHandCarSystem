			...
			<div class="rightcon" style="">
				...
				<form class="form-horizontal" role="form">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input class="form-control" name="brand_id" value="${requestScope.brandDetails.getBrand_id() }"  type="text" readonly="true">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">品牌名称</label>
						<div class="col-sm-8">
							<input class="form-control" name="brand_name" value="${requestScope.brandDetails.getBrand_name() }"  type="text">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-8">
							<select name="brand_be_query" class="form-control"> 
								<c:if test="${requestScope.brandDetails.getBrand_be_query() == 'true' }">
									<option value="true">可搜索</option>
								</c:if>
								<c:if test="${requestScope.brandDetails.getBrand_be_query() == 'false' }">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input class="form-control" name="brand_saleNum_month1" value="${requestScope.brandDetails.getBrand_saleNum_month1() }" type="text">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">一月销售价钱</label>
						<div class="col-sm-8">
							<input class="form-control" name="brand_salePrice_month1" value="${requestScope.brandDetails.getBrand_salePrice_month1() }" type="text">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">二月销量数量</label>
						<div class="col-sm-8">
							<input class="form-control" name="brand_saleNum_month2" value="${requestScope.brandDetails.getBrand_saleNum_month2() }" type="text">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">二月销售价钱</label>
						<div class="col-sm-8">
							<input class="form-control" name="brand_salePrice_month2" value="${requestScope.brandDetails.getBrand_salePrice_month2() }" type="text">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">三月销量数量</label>
						<div class="col-sm-8">
							<input class="form-control" name="brand_saleNum_month3" value="${requestScope.brandDetails.getBrand_saleNum_month3() }" type="text">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">三月销量价钱</label>
						<div class="col-sm-8">
							<input class="form-control" name="brand_salePrice_month3" value="${requestScope.brandDetails.getBrand_salePrice_month3() }" type="text">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">四月销量数量</label>
						<div class="col-sm-8">
							<input class="form-control" name="brand_saleNum_month4" value="${requestScope.brandDetails.getBrand_saleNum_month4() }" type="text">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">四月销量价钱</label>
						<div class="col-sm-8">
							<input class="form-control" name="brand_salePrice_month4" value="${requestScope.brandDetails.getBrand_salePrice_month4() }" type="text">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">五月销量数量</label>
						<div class="col-sm-8">
							<input class="form-control" name="brand_saleNum_month5" value="${requestScope.brandDetails.getBrand_saleNum_month5() }" type="text">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">五月销量价钱</label>
						<div class="col-sm-8">
							<input class="form-control" name="brand_salePrice_month5" value="${requestScope.brandDetails.getBrand_salePrice_month5() }" type="text">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">六月销量数量</label>
						<div class="col-sm-8">
							<input class="form-control" name="brand_saleNum_month6" value="${requestScope.brandDetails.getBrand_saleNum_month6() }" type="text">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">六月销量价钱</label>
						<div class="col-sm-8">
							<input class="form-control" name="brand_salePrice_month6" value="${requestScope.brandDetails.getBrand_salePrice_month6() }" type="text">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">七月销量数量</label>
						<div class="col-sm-8">
							<input class="form-control" name="brand_saleNum_month7" value="${requestScope.brandDetails.getBrand_saleNum_month7() }" type="text">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">七月销量价钱</label>
						<div class="col-sm-8">
							<input class="form-control" name="brand_salePrice_month7" value="${requestScope.brandDetails.getBrand_salePrice_month7() }" type="text">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">八月销量数量</label>
						<div class="col-sm-8">
							<input class="form-control" name="brand_saleNum_month8" value="${requestScope.brandDetails.getBrand_saleNum_month8() }" type="text">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">八月销量价钱</label>
						<div class="col-sm-8">
							<input class="form-control" name="brand_salePrice_month8" value="${requestScope.brandDetails.getBrand_salePrice_month8() }" type="text">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">九月销量数量</label>
						<div class="col-sm-8">
							<input class="form-control" name="brand_saleNum_month9" value="${requestScope.brandDetails.getBrand_saleNum_month9() }" type="text">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">九月销量价钱</label>
						<div class="col-sm-8">
							<input class="form-control" name="brand_salePrice_month9" value="${requestScope.brandDetails.getBrand_salePrice_month9() }" type="text">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">十月销量数量</label>
						<div class="col-sm-8">
							<input class="form-control" name="brand_saleNum_month10" value="${requestScope.brandDetails.getBrand_saleNum_month10() }" type="text">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">十月销量价钱</label>
						<div class="col-sm-8">
							<input class="form-control" name="brand_salePrice_month10" value="${requestScope.brandDetails.getBrand_salePrice_month10() }" type="text">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">十一月销量数量</label>
						<div class="col-sm-8">
							<input class="form-control" name="brand_saleNum_month11" value="${requestScope.brandDetails.getBrand_saleNum_month11() }" type="text">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">十一月销量价钱</label>
						<div class="col-sm-8">
							<input class="form-control" name="brand_salePrice_month11" value="${requestScope.brandDetails.getBrand_salePrice_month11() }" type="text">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">十二月销量数量</label>
						<div class="col-sm-8">
							<input class="form-control" name="brand_saleNum_month12" value="${requestScope.brandDetails.getBrand_saleNum_month12() }" type="text">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">十二月销量价钱</label>
						<div class="col-sm-8">
							<input class="form-control" name="brand_salePrice_month12" value="${requestScope.brandDetails.getBrand_salePrice_month12() }" type="text">
						</div>
					</div>
