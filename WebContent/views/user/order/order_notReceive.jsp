...
<html>
	...
	<body>
		...
		<div style="min-height:600px;auto;">
			...
			<a href="${pageContext.request.contextPath }/orderManage/notPayOrder"><button type="button" style="float:right" class="btn btn-success">未付款订单</button></a>
			
			
			<label style="margin-left:100px"><font size="4px">待收货订单页面</font></label>
			...
			<table class="table table-condensed table-hover" style="width:90%;" align="center">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								...
								<a href="${pageContext.request.contextPath }/orderManage/orderToReceive?order_id=${order.getOrder_id()}"><button class="btn btn-warning"> 收  货  </button></a>
							</td>
						</tr>
						</c:forEach>
				...
				<br><br>
				<label style="margin-left:100px"><font size="4px">共  ${requestScope.notReceiveOrder.size() } 条数据</font></label>
