...
<html>
	...
	<body>
		...
		<div style="min-height:600px;auto;">
			...
			<label style="margin-left:100px"><font size="4px">待付款订单页面</font></label>
			...
			<table class="table table-condensed table-hover" style="width:90%;" align="center">
					...
					<tbody>
						<c:forEach items="${requestScope.notPayOrder }" var="order">
						<tr>
							...
							<td><c:out value="${order.getOrder_addtime() }"></c:out></td>
							<td>
								<a href="${pageContext.request.contextPath }/orderManage/orderDetails?order_id=${order.getOrder_id()}"><button class="btn btn-primary"> 详 情  </button></a>
								<a href="${pageContext.request.contextPath }/orderManage/orderToPay?order_id=${order.getOrder_id()}"><button class="btn btn-warning"> 付 款  </button></a>
								<a href="${pageContext.request.contextPath }/orderManage/deleteOrder?order_id=${order.getOrder_id()}"><button class="btn btn-danger"> 取消订单  </button></a>
							</td>
						</tr>
						</c:forEach>
				...
				<br><br>
				<label style="margin-left:100px"><font size="4px">共  ${requestScope.notPayOrder.size() } 条数据</font></label>
