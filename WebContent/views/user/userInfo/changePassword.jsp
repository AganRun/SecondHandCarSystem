	...
	<body>
		...
		<div style="border:solid red 1px;height:700px">
			...
			<div style="height:130px;width:90%">
				<br><br>
				<a href="${pageContext.request.contextPath }/user/updateInfoInit"><button type="button" style="float:right" class="btn btn-info">个人信息修改</button></a>
			</div>
	 
			<form class="form-horizontal" role="form" id="updateInfoForm" action="${pageContext.request.contextPath }/user/changePassword">
				<div class="form-group">
